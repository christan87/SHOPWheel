exports.resetEmail = (host, resetToken) => {
  ...
  exports.merchantSignup = (host, { resetToken, email }) => {
    const message = {
      ...
      text: `${
        'Congratulations! Your application has been approved. Please complete your Merchant account signup by clicking on the link below. \n\n' +
        'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
        'http://'
