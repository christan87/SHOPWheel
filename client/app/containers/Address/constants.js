...
export const SET_ADDRESS_FORM_EDIT_ERRORS = 'src/Address/SET_ADDRESS_FORM_EDIT_ERRORS';
...
export const SET_ADDRESS_LOANDING = 'src/Address/SET_ADDRESS_LOANDING';
export const ADDRESS_SELECT = 'src/Address/ADDRESS_SELECT';
